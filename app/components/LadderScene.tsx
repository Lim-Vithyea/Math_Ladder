...
function SingleLadder({ score, totalSteps, emoji, color }: { score: number, totalSteps: number, emoji: string, color: string }) {
  ...
  return (
    <div className="relative" style={{ width: 120, height: ladderHeight }}>
      {/* Left rail */}
...
export default function LadderScene({ redScore, blueScore, totalSteps }: Props) {
  ...
  return (
    <div className="flex flex-col items-center select-none shrink-0" style={{ width: 400 }}>
      ...
      {/* Ground strip */}
      <div className="w-full h-12 bg-emerald-600 rounded-b-2xl shadow-inner mt-0 border-t-4 border-emerald-700" />
